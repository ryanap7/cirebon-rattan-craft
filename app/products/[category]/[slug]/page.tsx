...
const products: Record<string, Record<string, Product>> = {
  ...
  'living-room': {
    'luxury-living-room-suite': {
      ...
      description: 'Transform your living space with this luxurious rattan living room suite. Combining comfort with elegance, this complete set includes a three-seater sofa, two matching armchairs, and a beautiful coffee table. Each piece is meticulously crafted using premium Indonesian rattan.',
      features: [
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: `${product.name} | Premium Indonesian Rattan Furniture | Cirebon Rattan`,
    description: `${product.description.substring(0, 160)}...`,
    keywords: `${product.tags.join(', ')}, cirebon rattan furniture`,
    openGraph: {
    ...
    twitter: {
      ...
      title: `${product.name} - Cirebon Rattan`,
      description: product.description.substring(0, 200),
      images: [product.images[0]],
    },
  }
