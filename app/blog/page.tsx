...
const blogPosts = [
  {
    ...
    excerpt: 'Discover the ancient art of rattan weaving that has been passed down through generations in Cirebon, West Java. Learn about the intricate techniques that make Indonesian rattan furniture world-renowned.',
  ...
  },
  {
    ...
    excerpt: 'Keep your rattan furniture looking beautiful for years with these expert care tips. From daily maintenance to deep cleaning, learn the best practices for preserving your investment.',
    content: 'Full article content would go here...',
  ...
  },
  {
    ...
    excerpt: 'Explore the latest trends in rattan furniture design for 2024. From color palettes to innovative weaving patterns, discover what\'s shaping the industry this year.',
    content: 'Full article content would go here...',
  ...
  },
  {
    ...
    excerpt: 'Learn about the sustainable practices we employ in harvesting rattan from Indonesian forests. Discover how traditional methods support both quality and environmental conservation.',
    content: 'Full article content would go here...',
    image: 'https://images.pexels.com/photos/1743229/pexels-photo-1743229.jpeg',
    category: 'craftsmanship',
    author: {
      name: 'Dr. Bambang Forestry',
      avatar: 'https://images.pexels.com/photos/1743229/pexels-photo-1743229.jpeg',
  ...
  },
  {
    ...
    excerpt: 'A comprehensive guide to our export process, from order placement to delivery. Understand shipping methods, documentation, and what to expect when importing from Indonesia.',
    content: 'Full article content would go here...',
    image: 'https://images.pexels.com/photos/1571464/pexels-photo-1571464.jpeg',
    category: 'business-export',
    author: {
      name: 'Rudi Export Manager',
      avatar: 'https://images.pexels.com/photos/1571464/pexels-photo-1571464.jpeg',
  ...
  },
  {
    ...
    excerpt: 'Discover how to seamlessly blend traditional rattan furniture with contemporary interior design. Tips, tricks, and inspiration for creating stunning modern spaces.',
    content: 'Full article content would go here...',
    image: 'https://images.pexels.com/photos/1350789/pexels-photo-1350789.jpeg',
    category: 'design-trends',
    author: {
      name: 'Lisa Interior Designer',
      avatar: 'https://images.pexels.com/photos/1350789/pexels-photo-1350789.jpeg',
    ...
    <div className="min-h-screen pt-20 bg-cream-50">
      ...
      <section className="relative py-20 bg-hero-gradient overflow-hidden">
        ...
        <div 
          ...
          style={{
            backgroundImage: "url('https://images.pexels.com/photos/6969846/pexels-photo-6969846.jpeg')"
          }}
        ></div>
        ...
        <div className="container-max section-padding">
          ...
          >
            ...
            <p className="text-xl max-w-3xl mx-auto font-medium">
              Insights, tips, and stories about Indonesian rattan furniture craftsmanship, 
              care, design trends, and the export business.
            </p>
          </motion.div>
        </div>
      </section>
      ...
      <div className="container-max section-padding py-12">
        ...
        <motion.section
          ...
          className="mb-16"
        >
          <h2 className="text-3xl font-serif font-bold text-wood-900 mb-8">Featured Articles</h2>
            ...
            {featuredPosts.map((post, index) => (
              ...
              >
                ...
                <div className="p-6">
                  ...
                  <p className="text-wood-700 mb-4 line-clamp-3">{post.excerpt}</p>
                  
                  <div className="flex justify-between items-center">
                    <div className="flex items-center">
                      <div className="w-8 h-8 bg-wood-200 rounded-full mr-3"></div>
                      <span className="text-sm text-wood-600">{post.author.name}</span>
                    </div>
                    <Link
                      href={`/blog/${post.slug}`}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
          ...
          >
            <div className="bg-white rounded-xl shadow-soft p-6 sticky top-24">
              {/* Search */}
              <div className="mb-8">
                <h3 className="text-lg font-semibold text-wood-900 mb-4">Search Articles</h3>
              ...
              {/* Categories */}
              <div>
                <h3 className="text-lg font-semibold text-wood-900 mb-4">Categories</h3>
          ...
          >
                    ...
                    <div className="md:w-2/3 p-6">
                      ...
                      <div className="flex justify-between items-center">
                        <div className="flex items-center">
                          ...
                          <div>
                            <div className="font-medium text-wood-900">{post.author.name}</div>
            ...
            {filteredPosts.length === 0 && (
              <div className="text-center py-16">
                ...
                <h3 className="text-2xl font-semibold text-wood-900 mb-2">No articles found</h3>
            ...
            {filteredPosts.length > 0 && (
              <div className="flex justify-center mt-12">
                <nav className="flex space-x-2">
                  ...
                  <button className="px-4 py-2 bg-wood-600 text-white rounded-lg">1</button>
                  <button className="px-4 py-2 border border-cream-300 rounded-lg hover:bg-cream-50 transition-colors duration-200">
                    2
                  </button>
                  <button className="px-4 py-2 border border-cream-300 rounded-lg hover:bg-cream-50 transition-colors duration-200">
