...
import { ArrowRight, Star, Globe, Truck, Shield, Award, Heart, Users, Leaf, Factory } from 'lucide-react'
...
const featuredProducts = [
  ...
  },
  {
    ...
    description: "Complete living room set with sofas, coffee table, and accent chairs",
  ...
  },
  {
    ...
    description: "Elegant bedroom furniture including bed frame, nightstands, and dresser",
    ...
    <div className="min-h-screen">
      ...
      <section className="relative h-screen flex items-center justify-center overflow-hidden bg-hero-gradient">
        ...
        <div 
          ...
          style={{
            backgroundImage: "url('https://images.pexels.com/photos/6969835/pexels-photo-6969835.jpeg')"
          }}
        ></div>
        ...
        <div className="relative z-10 text-center text-white section-padding container-max">
          ...
          >
            ...
            <p className="text-xl md:text-2xl mb-8 max-w-3xl mx-auto font-light">
              Handcrafted in Cirebon with traditional techniques. Export quality furniture 
              that brings authentic Indonesian craftsmanship to your space.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                <Link href="/products" className="btn-accent inline-flex items-center">
                  View Our Collection
          ...
          >
            {trustSignals.map((signal, index) => (
              ...
              >
                ...
                <h3 className="font-semibold text-wood-900 mb-2">{signal.title}</h3>
        ...
        <div className="container-max section-padding">
          ...
          >
            ...
            <p className="text-xl text-wood-700 max-w-3xl mx-auto">
              Discover our premium rattan furniture collections, each piece meticulously 
              crafted by skilled artisans in Cirebon using sustainable materials.
            </p>
          </motion.div>
              ...
              >
                ...
                <div className="p-6">
                  ...
                  <div className="flex justify-between items-center">
                    <div>
                      <span className="text-xl font-bold text-forest-600">{product.price}</span>
                      <div className="text-xs text-wood-500">Starting price</div>
                    </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <p className="text-lg text-wood-700 mb-6">
                For over 25 years, we've been creating exceptional rattan furniture that combines 
                traditional Indonesian craftsmanship with contemporary design. Our skilled artisans 
                in Cirebon use sustainable materials and time-honored techniques passed down through generations.
              </p>
      ...
      <section className="py-20 bg-cream-100">
        <div className="container-max section-padding">
          ...
          >
            ...
            <p className="text-xl text-wood-700 max-w-3xl mx-auto">
              From raw rattan to finished furniture, discover the meticulous process 
              that creates our premium products.
            </p>
          </motion.div>
            ...
            {[
              {
                ...
                description: "Carefully selecting premium rattan from sustainable Indonesian forests",
                image: "https://images.pexels.com/photos/6969841/pexels-photo-6969841.jpeg"
              },
              {
                step: "02", 
                title: "Traditional Weaving",
                description: "Master craftsmen weave using techniques passed down through generations",
                image: "https://images.pexels.com/photos/6969842/pexels-photo-6969842.jpeg"
              },
              {
                step: "03",
                title: "Quality Control",
                description: "Rigorous inspection ensures every piece meets international standards",
                image: "https://images.pexels.com/photos/6969843/pexels-photo-6969843.jpeg"
              },
              {
                step: "04",
                title: "Export Packaging",
                description: "Professional packaging for safe international shipping",
                image: "https://images.pexels.com/photos/6969844/pexels-photo-6969844.jpeg"
              }
            ].map((process, index) => (
              <motion.div
                key={index}
              ...
              >
                ...
                <h3 className="text-xl font-semibold text-wood-900 mb-3">{process.title}</h3>
      ...
      <section className="py-20 bg-white">
        <div className="container-max section-padding">
          ...
          >
            ...
            <p className="text-xl text-wood-700 max-w-3xl mx-auto">
              Our commitment to quality has earned trust from customers worldwide, 
              making us a leading rattan furniture exporter from Indonesia.
            </p>
          </motion.div>

          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {[
              { number: "30+", label: "Countries Served", description: "Worldwide export reach" },
              { number: "10,000+", label: "Products Exported", description: "Annual production capacity" },
              { number: "150+", label: "Skilled Artisans", description: "Master craftspeople" },
              { number: "25+", label: "Years Experience", description: "Industry expertise" }
            ].map((stat, index) => (
              <motion.div
                key={index}
                initial={{ opacity: 0, y: 30 }}
              ...
              >
                <div className="text-4xl md:text-5xl font-bold text-forest-600 mb-2">{stat.number}</div>
                <div className="text-lg font-semibold text-wood-900 mb-1">{stat.label}</div>
      ...
      <section className="py-20 bg-cream-50">
        <div className="container-max section-padding">
          ...
          >
            ...
            <p className="text-xl text-wood-700 max-w-3xl mx-auto">
              Trusted by furniture retailers, interior designers, and hotels worldwide.
            </p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {testimonials.map((testimonial, index) => (
              ...
              >
                ...
                <p className="text-wood-700 mb-6 italic">"{testimonial.text}"</p>
                <div>
                  <div className="font-semibold text-wood-900">{testimonial.name}</div>
                  <div className="text-wood-600 text-sm">{testimonial.company}</div>
                </div>
              </motion.div>
            ))}
          </div>
        ...
        <div className="container-max section-padding text-center">
          ...
          >
            ...
            <p className="text-xl mb-8 max-w-3xl mx-auto opacity-90">
              Get a custom quote for your project. We offer competitive wholesale pricing, 
              reliable shipping, and exceptional customer service for international buyers.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                <Link href="/quote" className="bg-gold-500 hover:bg-gold-600 text-wood-900 font-semibold py-4 px-8 rounded-lg transition-all duration-300 shadow-lg hover:shadow-xl inline-flex items-center">
                  Get Custom Quote
                  <ArrowRight className="ml-2 h-5 w-5" />
                </Link>
              </motion.div>
              <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                <Link href="/contact" className="border-2 border-white text-white hover:bg-white hover:text-wood-900 font-semibold py-4 px-8 rounded-lg transition-all duration-300 inline-flex items-center">
                  Contact Us
                  <Globe className="ml-2 h-5 w-5" />
                </Link>
              </motion.div>
